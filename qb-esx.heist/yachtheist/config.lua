...
RegisterNetEvent('nafe-YachtHeist:CustomNotify')
AddEventHandler('nafe-YachtHeist:CustomNotify', function(message, type)
...
RegisterNetEvent('nafe-YachtHeist:PoliceAlert')
AddEventHandler('nafe-YachtHeist:PoliceAlert', function(coords)
