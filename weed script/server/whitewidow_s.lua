...
RegisterServerEvent('nafe-whitewidowjob:server:TrimWeed', function(args) 
	local src = source
                    ...
                    if baggies.amount >= baggieAmount then
                        ...
                        SetTimeout(packageTime, function()
                            if Player.Functions.AddItem('weed_skunk_cbd', returnAmount, nil, info, {["quality"] = 100}) then
                                ...
                                TriggerClientEvent('nafe-whitewidow:client:TrimmingMenu', src)
                            else
...
RegisterServerEvent('nafe-whitewidowjob:server:RollJoints', function(args) 
	local src = source
    local Player = QBCore.Functions.GetPlayer(src)
	local args = tonumber(args)
                    ...
                    if baggies.amount >= returnAmount then
                        ...
                        SetTimeout(packageTime, function()
                            if Player.Functions.AddItem('weed_skunk_cbd_joint', returnAmount, nil, info, {["quality"] = 100}) then
                                ...
                                TriggerClientEvent('nafe-whitewidow:client:RollJoints', src)
                            else
                                TriggerClientEvent('QBCore:Notify', src, 'Your pockets are full..', 'error')
                            end
                        end)
...
RegisterServerEvent('nafe-whitewidowjob:server:HarvestSkunk', function() 
    local src = source
    local Player  = QBCore.Functions.GetPlayer(src)
...
RegisterServerEvent('nafe-whitewidowjob:server:HarvestOGKush', function() 
    local src = source
    local Player  = QBCore.Functions.GetPlayer(src)
    local quantity = math.random(1, 3)
...
RegisterServerEvent('nafe-whitewidowjob:server:HarvestWhiteWidow', function() 
    local src = source
    local Player  = QBCore.Functions.GetPlayer(src)
    local quantity = math.random(1, 3)
...
-- Harvest og-kush plants
RegisterServerEvent('nafe-whitewidowjob:server:HarvestAK47', function() 
    local src = source
    local Player  = QBCore.Functions.GetPlayer(src)
    local quantity = math.random(1, 3)
...
-- White widow billing
RegisterServerEvent("nafe-whitewidowjob:client:WhiteWidowPay:player")
AddEventHandler("nafe-whitewidowjob:client:WhiteWidowPay:player", function(playerId, amount)
...
RegisterServerEvent('nafe-whitewidowjob:server:SpawnVehicle')
AddEventHandler('nafe-whitewidowjob:server:SpawnVehicle', function()
		local src = source
    	local Player = QBCore.Functions.GetPlayer(src)
		...
		if carprice >= Config.VehicleDeposit then
			...
			TriggerClientEvent('nafe-whitewidowjob:client:SpawnVehicle', src)
		else
...
RegisterServerEvent('nafe-whitewidowjob:server:DespawnVehicle')
AddEventHandler('nafe-whitewidowjob:server:DespawnVehicle', function()
		local src = source
    	local Player = QBCore.Functions.GetPlayer(src)
		TriggerClientEvent('nafe-whitewidowjob:client:DespawnVehicle', src)
end)
-- Use joints
QBCore.Functions.CreateUseableItem("weed_skunk_cbd_joint", function(source, item)
    ...
    if Player.Functions.GetItemByName(item.name) ~= nil then
        TriggerClientEvent("nafe-whitewidowjob:client:UseSkunkJoint", source)
    end
end)
QBCore.Functions.CreateUseableItem("weed_og-kush_cbd_joint", function(source, item)
    ...
    local Player = QBCore.Functions.GetPlayer(src)
    if Player.Functions.GetItemByName(item.name) ~= nil then
        TriggerClientEvent("nafe-whitewidowjob:client:UseOGKushJoint", source)
    end
end)
QBCore.Functions.CreateUseableItem("weed_white-widow_cbd_joint", function(source, item)
    ...
    local Player = QBCore.Functions.GetPlayer(src)
    if Player.Functions.GetItemByName(item.name) ~= nil then
        TriggerClientEvent("nafe-whitewidowjob:client:UseWhiteWidowJoint", source)
    end
end)
