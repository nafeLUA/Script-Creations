...
exports['qb-target']:AddBoxZone("whitewidowduty", Config.WhiteWidowDuty, 1.0, 10.0, {
    ...
    options = {
        {
            event = "nafe-whitewidowjob:client:WhiteWidowDutyMenu",
            icon = "fas fa-clock", 
            label = "Clock In/Out",
			job = "whitewidow",
        },
...
RegisterNetEvent('nafe-whitewidowjob:client:WhiteWidowDutyMenu', function(data)
    exports['qb-menu']:openMenu({
        ...
        { 
            ...
            params = {
                event = "nafe-whitewidowjob:client:SetDuty",
            }
        },
        {
            header = "< Exit",
...
RegisterNetEvent("nafe-whitewidowjob:client:SetDuty")
AddEventHandler("nafe-whitewidowjob:client:SetDuty", function()
    TriggerServerEvent("QBCore:ToggleDuty")
end)
...
exports['qb-target']:AddBoxZone("whitewidowstorage", Config.WhiteWidowStorage, 1.0, 40.0, {
        ...
        options = {
            {
                event = "nafe-whitewidowjob:client:WhiteWidowStorage",
                icon = "fas fa-box",
                label = "Storage",
                job = "whitewidow",
            },
...
-- White widow storage
RegisterNetEvent("nafe-whitewidowjob:client:WhiteWidowStorage")
AddEventHandler("nafe-whitewidowjob:client:WhiteWidowStorage", function()
...
exports['qb-target']:AddBoxZone("whitewidowpay", Config.WhiteWidowPay, 1.0, 40.0, {
    ...
    options = {
        {
            event = "nafe-whitewidowjob:client:WhiteWidowPay",
            parms = "1",
...
RegisterNetEvent("nafe-whitewidowjob:client:WhiteWidowPay", function()
    ...
    if dialog then
        ...
        TriggerServerEvent("nafe-whitewidowjob:client:WhiteWidowPay:player", dialog.id, dialog.amount)
    end
end)
...
exports['qb-target']:AddBoxZone("whitewidowtrim", Config.WhiteWidowTrim, 1.0, 10.0, {
    ...
    options = {
        {
            event = "nafe-whitewidow:client:TrimmingMenu",
...
RegisterNetEvent('nafe-whitewidow:client:TrimmingMenu', function()
    ...
    exports['qb-menu']:openMenu({
        ...
        },
        {
            ...
            params = {
                event = "nafe-whitewidowjob:server:TrimWeed",
                isServer = true,
                args = 1
            }
        },
        ...
        },
        {
            header = "< Exit",
            params = {
                event = "nafe-whitewidowjob:client:StopMenu"
            }
        },
    })
end)
...
exports['qb-target']:AddBoxZone("whitewidowjoints", Config.WhiteWidowJoints, 1.0, 10.0, {
    ...
    options = {
        {
            event = "nafe-whitewidow:client:RollJoints",
            icon = "fas fa-cannabis", 
            label = "Roll Joints",
			job = "whitewidow",
        },
...
RegisterNetEvent('nafe-whitewidow:client:RollJoints', function()
    TaskStartScenarioInPlace(PlayerPedId(), "PROP_HUMAN_PARKING_METER", 3500, false)
    exports['qb-menu']:openMenu({
        {
        ...
        },
        {
            ...
            params = {
                event = "nafe-whitewidowjob:server:RollJoints",
                isServer = true,
                args = 1
            }
        },
...
exports['qb-target']:AddBoxZone("whitewidowtray", Config.WhiteWidowTray, 1.0, 10.0, {
    ...
    options = {
        {
            event = "nafe-whitewidowjob:client:OpenTray",
            icon = "fas fa-box", 
            label = "Collect Order",
        },
    },
...
RegisterNetEvent("nafe-whitewidowjob:client:OpenTray")
AddEventHandler("nafe-whitewidowjob:client:OpenTray", function()
...
exports['qb-target']:AddBoxZone("skunkplants", Config.WhiteWidowWeed1, 1.0, 40.0, {
    ...
    options = {
        {
            event = "nafe-whitewidowjob:client:HarvestSkunk",
            icon = "fas fa-cannabis", 
...
exports['qb-target']:AddBoxZone("ogplants", Config.WhiteWidowWeed2, 1.0, 40.0, {
    ...
    options = {
        {
            event = "nafe-whitewidowjob:client:HarvestOGKush",
            icon = "fas fa-cannabis", 
...
exports['qb-target']:AddBoxZone("whitewidowplants", Config.WhiteWidowWeed3, 1.0, 50.0, {
    ...
    options = {
        {
            event = "nafe-whitewidowjob:client:HarvestWhiteWidow",
            icon = "fas fa-cannabis", 
...
exports['qb-target']:AddBoxZone("akplants", Config.WhiteWidowWeed4, 1.0, 40.0, {
    ...
    options = {
        {
            event = "nafe-whitewidowjob:client:HarvestAK47",
            icon = "fas fa-cannabis", 
...
RegisterNetEvent('nafe-whitewidowjob:client:HarvestWhiteWidow', function()
    ...
    if finished ~= 100 then
        ...
        if finished2 ~= 100 then
            ...
            if finished3 ~= 100 then
                ...
                Wait(HarvestTime)
                TriggerServerEvent('nafe-whitewidowjob:server:HarvestWhiteWidow')
                ClearPedTasks(playerPed)
...
-- Harvest og-kush plants
RegisterNetEvent('nafe-whitewidowjob:client:HarvestAK47', function()
	local playerPed = PlayerPedId()
    playAnim("anim@amb@business@weed@weed_inspecting_lo_med_hi@", "weed_crouch_checkingleaves_idle_01_inspector", 35000)
	local finished = exports["reload-skillbar"]:taskBar(math.random(5000,5001),math.random(2,4))
    if finished ~= 100 then
        ...
        if finished2 ~= 100 then
            ...
            if finished3 ~= 100 then
                ...
                Wait(HarvestTime)
                TriggerServerEvent('nafe-whitewidowjob:server:HarvestAK47')
                ClearPedTasks(playerPed)
                FreezeEntityPosition(playerPed, false)
            end
        end
...
exports['qb-target']:AddBoxZone("whitewidowgarage", Config.WhiteWidowGarage, 1.0, 40.0, {
    ...
    options = {
        {
            event = "nafe-whitewidowjob:client:GetVehicle",
            icon = "fas fa-car", 
...
-- Take out vehicle
RegisterNetEvent('nafe-whitewidowjob:client:GetVehicle', function()
    exports['qb-menu']:openMenu({
        {
        ...
        },
        {
            ...
            params = {
                event = "nafe-whitewidowjob:server:SpawnVehicle",
                isServer = true,
            }
        },
		{
            ...
            params = {
                event = "nafe-whitewidowjob:server:DespawnVehicle",
                isServer = true,
            }
        },
        {
...
RegisterNetEvent('nafe-whitewidowjob:client:SpawnVehicle')
AddEventHandler('nafe-whitewidowjob:client:SpawnVehicle', function()
...
-- Despawn vehicle
RegisterNetEvent('nafe-whitewidowjob:client:DespawnVehicle')
AddEventHandler('nafe-whitewidowjob:client:DespawnVehicle', function()
	DeleteEntity(spawnedveh)
	rented = false
end)
-- Use joint effects
-- Use joint skunk
RegisterNetEvent('nafe-whitewidowjob:client:UseSkunkJoint', function()
	local playerPed = PlayerPedId()
...
-- Use joint ogkush
RegisterNetEvent('nafe-whitewidowjob:client:UseOGKushJoint', function()
	local playerPed = PlayerPedId()
	QBCore.Functions.TriggerCallback('QBCore:HasItem', function(HasItem)
		if HasItem then
				isSmokingJoint = true
...
RegisterNetEvent('nafe-whitewidowjob:client:UseWhiteWidowJoint', function()
	local playerPed = PlayerPedId()
	QBCore.Functions.TriggerCallback('QBCore:HasItem', function(HasItem)
		if HasItem then
				isSmokingJoint = true
...
-- Use joint ak47
RegisterNetEvent('nafe-whitewidowjob:client:UseAK47Joint', function()
	local playerPed = PlayerPedId()
	QBCore.Functions.TriggerCallback('QBCore:HasItem', function(HasItem)
		if HasItem then
				isSmokingJoint = true
...
RegisterNetEvent('nafe-whitewidowjob:client:StopMenu', function()
